...
const shieldsReducer = (state = initialState, action) => {
  switch (action.type) {
    case DAMAGE_SHIELD:
      ...
      // YOUR TURN: You now have the shield level from state and amount of change from the action.
      // Given that this is the DAMAGE_SHIELD reducer, write the logic to reflect what should happen
      // YOUR CODE HERE
