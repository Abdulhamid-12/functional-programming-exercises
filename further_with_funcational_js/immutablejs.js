...
// SOLUTION
// You can do this:
// const state2 = map1.set("name", "Mal");
// const state3 = map1.set("role", "Captain");

// But Immutable also allows you to do this:
const state02 = map1.set("name", "Mal").set("role", "Captain");
console.log(state02.toJS());
// -----------------------------------------------------------------
// -----------------------------------------------------------------
...
const chars = Immutable.List(characters);
// const chars02 = chars.remove(1);
// console.log(Array.from(chars02));
...
const allatonce = Immutable.List(characters)
  .push({
    name: "Yoda",
    role: "Jedi Master",
    universe: "Star Wars",
